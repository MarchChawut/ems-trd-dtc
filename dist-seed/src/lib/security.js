...
exports.createLeaveSchema = exports.createTaskSchema = exports.createUserSchema = exports.loginSchema = void 0;
...
exports.createUserSchema = zod_1.z.object({
    ...
    prefix: zod_1.z.string().max(50).nullable().optional(),
    name: zod_1.z
        .string()
        .min(1, 'กรุณาระบุชื่อ')
        .max(100, 'ชื่อต้องไม่เกิน 100 ตัวอักษร'),
    role: zod_1.z.enum(['SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EMPLOYEE', 'HR']),
...
exports.createTaskSchema = zod_1.z.object({
    ...
    columnId: zod_1.z.number().int().positive().optional(),
...
exports.createLeaveSchema = zod_1.z.object({
    type: zod_1.z.enum(['SICK', 'PERSONAL', 'VACATION', 'MATERNITY', 'ORDINATION', 'OTHER']),
    startDate: zod_1.z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'รูปแบบวันที่ต้องเป็น YYYY-MM-DD'),
    endDate: zod_1.z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'รูปแบบวันที่ต้องเป็น YYYY-MM-DD'),
    reason: zod_1.z
        .string()
