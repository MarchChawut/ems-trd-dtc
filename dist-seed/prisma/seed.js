...
async function main() {
    ...
    const adminPassword = await (0, security_1.hashPassword)('TRD02.trd02');
    ...
    const userPassword = await (0, security_1.hashPassword)('trd-dtc.123');
    const sampleUsers = [
        {
            email: 'ppong@ems.local',
            username: 'ppong',
    ...
    const sampleLeaves = [
        ...
        {
            userId: 3, // วิชัย
            type: client_1.LeaveType.PERSONAL,
            startDate: tomorrow,
